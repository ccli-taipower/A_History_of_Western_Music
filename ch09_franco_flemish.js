...
// ── SLIDE 2 · Chapter Overview ───────────────────────────────────────────────
{
  ...
  s.addText("本章概覽 Chapter Overview", { x: 0.4, y: 0.2, w: 9.2, h: 0.6, fontSize: 26, bold: true, color: C.violet, fontFace: "Georgia", margin: 0 });
  ...
  sections.forEach(([icon, title, sub], i) => {
    ...
    s.addText(sub, { x: 1.15, y: y + 0.28, w: 8.4, h: 0.26, fontSize: 14, color: C.midViolet, fontFace: "Calibri", valign: "top", margin: 0 });
  });
}
...
// ── SLIDE 3 · Political Change ───────────────────────────────────────────────
{
  ...
  s.addText("Political Change & the Rise of National Monarchies", { x: 0.4, y: 0.72, w: 9.2, h: 0.38, fontSize: 14, color: C.sand, fontFace: "Georgia", align: "center" });
  s.addShape(pres.ShapeType.rect, { x: 1.5, y: 1.12, w: 7, h: 0.04, fill: { color: C.gold } });

  // Left — Kingdoms
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 1.3, w: 4.6, h: 4.1, fill: { color: "2E2740" }, rounding: true });
  s.addText("■ 新興王國 Emerging Kingdoms", { x: 0.45, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.gold, fontFace: "Georgia", margin: 0 });
  ...
  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 1.3, w: 4.6, h: 4.1, fill: { color: "2E2740" }, rounding: true });
  s.addText("■ Hapsburg & 義大利戰爭", { x: 5.25, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.gold, fontFace: "Georgia", margin: 0 });
  s.addText("Hapsburg 的婚姻帝國\n• 1478 Maximilian I 娶 Mary of Burgundy\n• 其孫 Charles V 同時統治 Spain、\n  尼德蘭、奧地利、美洲\n\n1494 義大利戰爭 Italian Wars\n• 法王 Charles VIII 入侵義大利\n• 法、西、帝國長期爭奪半島\n• 城邦文化外溢——音樂家往返南北\n• 刺激印刷、出版業興盛\n\n文化效應\n• 北方作曲家南下義大利任職\n• 音樂家成為國際商品", {
...
// ── SLIDE 4 · Ockeghem Biography ─────────────────────────────────────────────
{
  ...
  s.addText("ca. 1420–1497 · 法國王室禮拜堂首席作曲家", { x: 0.4, y: 0.78, w: 9.2, h: 0.35, fontSize: 14, color: C.slate, fontFace: "Georgia", align: "center" });
  s.addShape(pres.ShapeType.rect, { x: 2.5, y: 1.15, w: 5, h: 0.04, fill: { color: C.violet } });

  // Left — Career
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 1.3, w: 4.6, h: 4.1, fill: { color: "EADFEC" }, rounding: true });
  s.addText("■ 生平 Career", { x: 0.45, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.violet, fontFace: "Georgia", margin: 0 });
  s.addText("• 生於今比利時法蘭德斯區\n• 1443 在 Antwerp 大教堂擔任歌手\n• 1446–48 服侍 Bourbon 公爵\n• 1451 起進入法國王室禮拜堂\n  服侍 Charles VII、Louis XI、\n  Charles VIII 三位國王\n• 1453 升任禮拜堂首席\n• 1459 獲授 Tours 司庫——顯赫俸祿\n• Josquin 寫 motet 悼念其逝世", {
    x: 0.5, y: 1.88, w: 4.35, h: 3.55, fontSize: 14, color: C.darkText, fontFace: "Calibri", paraSpaceAfter: 1, valign: "top",
  });

  // Right — Works Overview
  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 1.3, w: 4.6, h: 4.1, fill: { color: "EADFEC" }, rounding: true });
  s.addText("■ 作品總覽 Works", { x: 5.25, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.violet, fontFace: "Georgia", margin: 0 });
  s.addText("• 13 首完整彌撒曲——Du Fay 之後最多\n• 1 首 Requiem——現存最早的複音安魂曲\n• 10 首經文歌 · 20 餘首世俗香頌\n\n■ 風格特徵\n• 聲部線條綿長、呼吸錯落——避免齊句\n• 喜好低音域——四部常延伸到男低音\n• 各聲部節奏獨立、對位高度流動\n• 神秘沉思的氣質——與北方神秘主義共鳴\n\n著名彌撒\n• Missa prolationum（mensuration canon 傑作）\n• Missa cuiusvis toni（可按任一調式演唱）\n• Missa De plus en plus（Binchois 香頌為 c.f.）", {
...
// ── SLIDE 5 · Ockeghem's Masses & Canon Art ──────────────────────────────────
{
  ...
  s.addText("Canon, Mensuration & Modal Ingenuity", { x: 0.4, y: 0.72, w: 9.2, h: 0.38, fontSize: 14, color: C.sand, fontFace: "Georgia", align: "center" });
  s.addShape(pres.ShapeType.rect, { x: 1.5, y: 1.12, w: 7, h: 0.04, fill: { color: C.gold } });

  // Missa prolationum
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 1.3, w: 4.6, h: 4.1, fill: { color: "2E2740" }, rounding: true });
  s.addText("■ Missa prolationum", { x: 0.45, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.gold, fontFace: "Georgia", margin: 0 });
  s.addText("「節拍比例彌撒」——最精巧的技術之作\n\n• 四聲部僅以兩行記譜——每行以兩種\n  mensuration 讀出\n• 每樂章為 double mensuration canon\n• 兩個卡農同時——兩對聲部以不同\n  速度與時值展開\n• 卡農音程逐樂章擴大：unison → 八度\n\n意義\n• 展現對 ars perfecta 的終極掌握\n• 保持流暢對位與虔誠宗教感\n• 以技巧表達神學完美", {
    x: 0.5, y: 1.88, w: 4.35, h: 3.55, fontSize: 14, color: C.sand, fontFace: "Calibri", paraSpaceAfter: 1, valign: "top",
  });

  // Cuiusvis toni & other innovations
  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 1.3, w: 4.6, h: 4.1, fill: { color: "2E2740" }, rounding: true });
  s.addText("■ Missa cuiusvis toni & 其他", { x: 5.25, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.gold, fontFace: "Georgia", margin: 0 });
  s.addText("Missa cuiusvis toni「可用任何調式之彌撒」\n• 同一份樂譜可用 Dorian / Phrygian /\n  Lydian / Mixolydian 任意演唱\n• 只需更換 clef——旋律關係隨調式改變\n\nRequiem（Missa pro defunctis）\n• 現存最早的複音安魂曲\n• 保留大量 chant——以 paraphrase 華麗化\n\n風格總評\n• 後世視 Ockeghem 為「對位魔法師」\n• Tinctoris 列入最具才華的現代作曲家\n• 影響 Josquin、Obrecht、de la Rue 一整代", {
    x: 5.3, y: 1.88, w: 4.35, h: 3.55, fontSize: 14, color: C.sand, fontFace: "Calibri", paraSpaceAfter: 1, valign: "top",
  });
}
...
// ── SLIDE 6 · Busnoys & Je ne puis vivre ─────────────────────────────────────
{
  ...
  s.addText("ca. 1430–1492 · 勃艮第末代香頌大師", { x: 0.4, y: 0.78, w: 9.2, h: 0.35, fontSize: 14, color: C.slate, fontFace: "Georgia", align: "center" });
  s.addShape(pres.ShapeType.rect, { x: 2.5, y: 1.15, w: 5, h: 0.04, fill: { color: C.wine } });

  // Left — Bio
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 1.3, w: 4.6, h: 4.1, fill: { color: "F3E0E0" }, rounding: true });
  s.addText("■ 生平", { x: 0.45, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.wine, fontFace: "Georgia", margin: 0 });
  ...
  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 1.3, w: 4.6, h: 4.1, fill: { color: "F3E0E0" }, rounding: true });
  s.addText("■ Je ne puis vivre (NAWM 38)", { x: 5.25, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.wine, fontFace: "Georgia", margin: 0 });
  s.addText("「若非如此我不能活」——三聲部 virelai\n\n• 結構：bergerette（單節 virelai）\n• 上聲部主導旋律——下兩聲部伴奏性質\n• 規律節奏、清晰樂句——與 Ockeghem 迥異\n\n■ 歷史意義\n• 低音終止式跳進四／五度\n• 產生近代 V–I 終止感——authentic cadence 遠祖\n• 從中世紀終止式走向調性終止的關鍵一步\n\n• 文本可能 Busnoys 自撰——字首藏詩暗示\n  Jacqueline d'Hacqueville，作曲家戀慕對象", {
    x: 5.3, y: 1.88, w: 4.35, h: 3.55, fontSize: 14, color: C.darkText, fontFace: "Calibri", paraSpaceAfter: 1, valign: "top",
  });
}
...
// ── SLIDE 7 · Generation of 1480-1520 ────────────────────────────────────────
{
  ...
  s.addText("The Generation of 1480–1520 · Imitation Becomes the Norm", { x: 0.4, y: 0.72, w: 9.2, h: 0.38, fontSize: 14, color: C.sand, fontFace: "Georgia", align: "center" });
  s.addShape(pres.ShapeType.rect, { x: 1.5, y: 1.12, w: 7, h: 0.04, fill: { color: C.gold } });
  ...
  composers.forEach((c, i) => {
    ...
    s.addText(c.name, { x: x + 0.15, y: y + 0.08, w: 3, h: 0.28, fontSize: 14, bold: true, color: C.gold, fontFace: "Georgia", margin: 0 });
    s.addText(c.dates, { x: x + 3.1, y: y + 0.08, w: 1.4, h: 0.28, fontSize: 14, color: C.sand, fontFace: "Calibri", valign: "top", align: "right" });
    s.addText(c.region, { x: x + 0.15, y: y + 0.38, w: 4.35, h: 0.26, fontSize: 14, italic: false, color: "C0A0D8", fontFace: "Calibri", valign: "top" });
    s.addText(c.focus, { x: x + 0.15, y: y + 0.62, w: 4.35, h: 0.55, fontSize: 14, color: C.sand, fontFace: "Calibri", valign: "top" });
  });
}
...
// ── SLIDE 8 · Jacob Obrecht & Missa Fortuna desperata ────────────────────────
{
  ...
  s.addText("1457/8–1505 · 結構宏大的彌撒建築師", { x: 0.4, y: 0.78, w: 9.2, h: 0.35, fontSize: 14, color: C.slate, fontFace: "Georgia", align: "center" });
  s.addShape(pres.ShapeType.rect, { x: 2.5, y: 1.15, w: 5, h: 0.04, fill: { color: C.violet } });

  // Bio
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 1.3, w: 4.6, h: 4.1, fill: { color: "EADFEC" }, rounding: true });
  s.addText("■ 生平", { x: 0.45, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.violet, fontFace: "Georgia", margin: 0 });
  ...
  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 1.3, w: 4.6, h: 4.1, fill: { color: "EADFEC" }, rounding: true });
  s.addText("■ Missa Fortuna desperata", { x: 5.25, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.violet, fontFace: "Georgia", margin: 0 });
...
// ── SLIDE 9 · Heinrich Isaac ─────────────────────────────────────────────────
{
  ...
  s.addText("ca. 1450–1517 · 國際化的北方作曲家", { x: 0.4, y: 0.72, w: 9.2, h: 0.38, fontSize: 14, color: C.sand, fontFace: "Georgia", align: "center" });
  s.addShape(pres.ShapeType.rect, { x: 2.5, y: 1.12, w: 5, h: 0.04, fill: { color: C.gold } });

  // Left — Career
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 1.3, w: 4.6, h: 4.1, fill: { color: "2E2740" }, rounding: true });
  s.addText("■ Career Across Europe", { x: 0.45, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.gold, fontFace: "Georgia", margin: 0 });
  ...
  // Right — Works
  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 1.3, w: 4.6, h: 4.1, fill: { color: "2E2740" }, rounding: true });
  s.addText("■ 代表作品", { x: 5.25, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.gold, fontFace: "Georgia", margin: 0 });
  s.addText("Choralis Constantinus\n• 三冊巨型 Proper 合唱集\n• 原為 Constance 主教座堂委託\n• 涵蓋教會年全部專用經\n• 死後出版——德語地區影響深遠\n\nPuer natus est (NAWM 40)\n• 聖誕日 Introit · paraphrase chant\n\nInnsbruck, ich muss dich lassen\n(NAWM 41) · 德語 Tenorlied\n• 後成 chorale《O Welt, ich muss\n  dich lassen》· Bach 引用", {
    x: 5.3, y: 1.88, w: 4.35, h: 3.55, fontSize: 14, color: C.sand, fontFace: "Calibri", paraSpaceAfter: 1, valign: "top",
  });
}
...
// ── SLIDE 10 · Josquin Biography ─────────────────────────────────────────────
{
  ...
  s.addText("ca. 1450–1521 · 文藝復興最偉大的作曲家", { x: 0.4, y: 0.78, w: 9.2, h: 0.35, fontSize: 14, color: C.slate, fontFace: "Georgia", align: "center" });
  s.addShape(pres.ShapeType.rect, { x: 2.5, y: 1.15, w: 5, h: 0.04, fill: { color: C.wine } });

  // Career timeline
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 1.3, w: 9.4, h: 4.1, fill: { color: "F3E0E0" }, rounding: true });
  s.addText("■ 生平與職涯 Career", { x: 0.5, y: 1.38, w: 9, h: 0.4, fontSize: 14, bold: true, color: C.wine, fontFace: "Georgia", margin: 0 });
  ...
  events.forEach(([date, desc], i) => {
    ...
    s.addText(date, { x, y, w: 1.2, h: 0.32, fontSize: 14, bold: true, color: C.wine, fontFace: "Georgia", margin: 0 });
    s.addText(desc, { x: x + 1.25, y, w: 3.35, h: 0.75, fontSize: 14, color: C.darkText, fontFace: "Calibri", valign: "top" });
  });
}
...
// ── SLIDE 11 · Josquin's Motets & Text Expression ───────────────────────────
{
  ...
  s.addText("Motets · Text Declamation · Text Depiction · Text Expression", { x: 0.4, y: 0.72, w: 9.2, h: 0.38, fontSize: 14, color: C.sand, fontFace: "Georgia", align: "center" });
  s.addShape(pres.ShapeType.rect, { x: 1.5, y: 1.12, w: 7, h: 0.04, fill: { color: C.gold } });

  // Left — Ave Maria
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 1.3, w: 4.6, h: 4.1, fill: { color: "2E2740" }, rounding: true });
  s.addText("■ Ave Maria...virgo serena (NAWM 44)", { x: 0.45, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.gold, fontFace: "Georgia", margin: 0 });
  ...
  // Right — 3 Techniques
  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 1.3, w: 4.6, h: 4.1, fill: { color: "2E2740" }, rounding: true });
  s.addText("■ 三種文字處理", { x: 5.25, y: 1.38, w: 4.3, h: 0.4, fontSize: 14, bold: true, color: C.gold, fontFace: "Georgia", margin: 0 });
  s.addText("1■⃣ Text Declamation 文字宣告\n• 節奏對應自然言語重音\n• 每個音節清晰可辨\n\n2■⃣ Text Depiction 文字描繪\n• 音樂形象呼應字詞具象意義\n• 「上升」用上行音階；「下降」用下行音階\n• 「嘆息」用短促休止；「哭泣」用半音\n\n3■⃣ Text Expression 文字表達\n• 音樂整體情緒對應文本情感\n• 不是模仿字面——而是捕捉心境\n• Josquin 首次系統性運用——被 Glareanus 稱為「音樂中的 Virgil」\n\n其他名作\n• Faulte d'argent (NAWM 42) · 五聲部卡農香頌\n• Mille regretz (NAWM 43) · 查理五世之愛歌", {
    x: 5.3, y: 1.88, w: 4.35, h: 3.55, fontSize: 14, color: C.sand, fontFace: "Calibri", paraSpaceAfter: 1, valign: "top",
  });
}
...
// ── SLIDE 12 · Josquin's Masses ──────────────────────────────────────────────
{
  ...
  s.addText("18+ Masses · Four Great Examples", { x: 0.4, y: 0.78, w: 9.2, h: 0.35, fontSize: 14, color: C.slate, fontFace: "Georgia", align: "center" });
  s.addShape(pres.ShapeType.rect, { x: 2.5, y: 1.15, w: 5, h: 0.04, fill: { color: C.violet } });
  ...
  masses.forEach((m, i) => {
    ...
    s.addText(m.title, { x: x + 0.15, y: y + 0.08, w: 4.35, h: 0.32, fontSize: 14, bold: true, color: C.violet, fontFace: "Georgia", margin: 0 });
    s.addText(m.type, { x: x + 0.15, y: y + 0.42, w: 4.35, h: 0.26, fontSize: 14, color: C.wine, fontFace: "Georgia" });
    s.addText(m.desc, { x: x + 0.15, y: y + 0.7, w: 4.35, h: 1.1, fontSize: 14, color: C.darkText, fontFace: "Calibri", valign: "top" });
  });
}
...
// ── SLIDE 13 · Masses on Borrowed Material (Comparison) ─────────────────────
{
  ...
  s.addText("以借材為基礎的四種彌撒", { x: 0.4, y: 0.18, w: 9.2, h: 0.5, fontSize: 24, bold: true, color: C.gold, fontFace: "Georgia", align: "center" });
  s.addText("Four Types of Masses on Borrowed Material (Figure 9.5)", { x: 0.4, y: 0.65, w: 9.2, h: 0.35, fontSize: 14, color: C.sand, fontFace: "Georgia", align: "center" });

  const rows = [
    ["類型 Type", "借材 Borrowing", "技術 Technique", "代表 Example"],
    ["Cantus-firmus\nmass", "chant 或俗歌\n的單一聲部", "置於 tenor，\n常以長音值出現", "Du Fay\nMissa Se la face"],
    ["Cantus-firmus /\nimitation", "單一聲部 +\n模仿擴散", "tenor 持 c.f.，\n動機貫穿各部", "Obrecht Missa\nFortuna desperata"],
    ["Paraphrase\nmass", "chant 旋律\n（單聲部）", "旋律華麗化，\n散布於所有聲部", "Josquin Missa\nPange lingua"],
    ["Imitation /\nParody", "整首複音作品\n（全部聲部）", "重用原作織度\n與動機全體", "Févin Missa\nAve Maria（首例）"],
  ];
  const colW = [2.1, 2.6, 2.8, 2.3];
  const xStart = 0.1;
  const rowH = 0.82;
  const yStart = 1.05;
  rows.forEach((row, ri) => {
    ...
    row.forEach((cell, ci) => {
      ...
      s.addShape(pres.ShapeType.rect, {
        x, y: yStart + ri * rowH, w: colW[ci], h: rowH,
        fill: { color: isHeader ? C.violet : "2E2740" },
        line: { color: C.gold, width: 0.5 },
      });
      s.addText(cell, {
        x: x + 0.08, y: yStart + ri * rowH, w: colW[ci] - 0.16, h: rowH,
        fontSize: 14, bold: isHeader,
...
// ── SLIDE 14 · Timeline & Legacy ─────────────────────────────────────────────
{
  ...
  events.forEach(([date, desc], i) => {
    ...
    s.addText(date, { x: x + 0.05, y: y + 0.06, w: 0.85, h: 0.4, fontSize: 14, bold: true, color: C.lightText, align: "center", fontFace: "Georgia" });
    s.addText(desc, { x: x + 1.05, y, w: 3.65, h: 0.52, fontSize: 14, color: C.darkText, fontFace: "Calibri", valign: "middle" });
  });
}
...
// ── SLIDE 15 · Key Terms & Further Reading ──────────────────────────────────
{
  ...
  s.addText("關鍵詞彙 · 延伸閱讀", { x: 0.4, y: 0.18, w: 9.2, h: 0.48, fontSize: 24, bold: true, color: C.gold, fontFace: "Georgia", align: "center" });
  s.addText("Key Terms & Further Reading", { x: 0.4, y: 0.62, w: 9.2, h: 0.32, fontSize: 14, color: C.sand, fontFace: "Georgia", align: "center" });

  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 1.0, w: 4.6, h: 4.3, fill: { color: "2E2740" }, rounding: true });
  s.addText("■ Key Terms", { x: 0.45, y: 1.05, w: 4.3, h: 0.3, fontSize: 14, bold: true, color: C.gold, fontFace: "Georgia", margin: 0 });
  s.addText("• mensuration canon · 節拍比例卡農\n• soggetto cavato · 母音抽字主題\n• paraphrase mass · 華飾彌撒\n• imitation mass (parody) · 模仿彌撒\n• cantus-firmus–imitation mass\n• points of imitation · 模仿點\n• text declamation / depiction\n• Requiem (Missa pro defunctis)\n• bergerette · 單節 virelai\n• authentic cadence · 正格終止\n• Proper cycle · 專用經套曲\n• Tenorlied · 德文 tenor 歌曲", {
    x: 0.5, y: 1.38, w: 4.35, h: 3.85, fontSize: 14, color: C.sand, fontFace: "Calibri", paraSpaceAfter: 1, valign: "top",
  });

  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 1.0, w: 4.6, h: 4.3, fill: { color: "2E2740" }, rounding: true });
  s.addText("■ NAWM 精選聆聽 YouTube", { x: 5.25, y: 1.05, w: 4.3, h: 0.3, fontSize: 14, bold: true, color: C.gold, fontFace: "Georgia", margin: 0 });
  s.addText("38 · Busnoys · Je ne puis vivre\nyoutu.be/-hcvz1qvJwc\n39 · Ockeghem · Missa prolationum\nyoutu.be/ZWLsLAujZzI\n40 · Isaac · Puer natus est\nyoutu.be/Y2k88BgrFBY\n41 · Isaac · Innsbruck ich muss...\nyoutu.be/Dk84ddXJ8tY\n42 · Josquin · Faulte d'argent\nyoutu.be/WLkbxj85bKU\n43 · Josquin · Mille regretz\nyoutu.be/1fSZ7sTYNTM\n44 · Josquin · Ave Maria\nyoutu.be/scQ5YBRpwNg\n45 · Josquin · Pange lingua\nyoutu.be/_zxnFVWZVcE", {
    x: 5.3, y: 1.38, w: 4.35, h: 3.85, fontSize: 14, color: C.sand, fontFace: "Calibri", paraSpaceAfter: 0, valign: "top",
  });
}
