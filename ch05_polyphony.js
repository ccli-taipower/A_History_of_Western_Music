...
// ── SLIDE 1 · Title ──────────────────────────────────────────────────────────
{
  ...
  s.addText("Organum · Aquitanian · Notre Dame · Motet · Franconian Notation", {
    ...
    fontSize: 13, color: C.sand, italic: true, align: "center", fontFace: "Georgia",
  });
...
// ── SLIDE 3 · Four Distinguishing Concepts ───────────────────────────────────
{
  ...
  s.addText("Four Concepts That Distinguish Western Music from Most Other Traditions", {
    x: 0.4, y: 0.72, w: 9.2, h: 0.38, fontSize: 13, color: C.sand, fontFace: "Georgia", align: "center",
  });
  ...
  concepts.forEach(([num, name, desc], i) => {
    ...
    s.addText(desc, { x: 1.2, y: y + 0.4, w: 8.4, h: 0.45, fontSize: 10, color: C.sand, fontFace: "Calibri", margin: 0 });
  });
...
// ── SLIDE 4 · Early Organum ──────────────────────────────────────────────────
{
  ...
  s.addText("9th–11th Centuries · The First Written Polyphony of the West", {
    x: 0.4, y: 0.7, w: 9.2, h: 0.3, fontSize: 12, color: C.midBrown, fontFace: "Calibri", margin: 0,
  });
  ...
  s.addText("① 平行奧爾加農 Parallel Organum", {
    x: 0.45, y: 1.26, w: 4.3, h: 0.32, fontSize: 12, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("Musica enchiriadis（ca. 850–890 抄本）\n• 主要聲部唱聖詠\n• 附加聲部（organal voice）平行五度或四度\n• 四度平行因三全音（tritone）問題而較複雜\n  → 產生混合平行與斜行的修正版本", {
    x: 0.5, y: 1.6, w: 4.2, h: 1.55, fontSize: 9.5, color: C.cream, fontFace: "Calibri",
  });
  ...
  s.addText("② 混合平行與斜行 Mixed Parallel/Oblique", {
    x: 5.25, y: 1.26, w: 4.3, h: 0.32, fontSize: 12, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("Guido of Arezzo — Micrologus (ca. 1025–28)\n• 為避免三全音，聲部有時保持同音（斜行）\n• 兩聲部得以同音開始、結束\n• Winchester Troper（英格蘭，ca. 992–996）\n  收錄 174 首由 Wulfstan 創作的奧爾加農", {
    x: 5.3, y: 1.6, w: 4.2, h: 1.55, fontSize: 9.5, color: C.cream, fontFace: "Calibri",
  });
  ...
  s.addText("③ 音對音奧爾加農 Note-Against-Note", {
    x: 0.45, y: 3.42, w: 4.3, h: 0.32, fontSize: 12, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("• 11 世紀後期 · 附加聲部置於聖詠之上\n• 使用逆向（contrary）與斜行（oblique）\n• 聲部常交叉——更自由的橫向線條\n• 已使用三度作為協和音程\n• 由 organal voice 變為 upper voice", {
    x: 0.5, y: 3.76, w: 4.2, h: 1.45, fontSize: 9.5, color: C.cream, fontFace: "Calibri",
  });
  ...
  s.addText("📘 Ad organum faciendum", {
    x: 5.25, y: 3.42, w: 4.3, h: 0.32, fontSize: 12, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("「如何作奧爾加農」· ca. 1100\n• 最重要的早期複音實用教本\n• 提供音對音複音的具體範例\n• 此時複音仍被視為對聖詠的即興裝飾\n• 手稿中的記譜僅供教學——實際演唱\n  大多仍為即興與口傳", {
    x: 5.3, y: 3.76, w: 4.2, h: 1.45, fontSize: 9.5, color: C.cream, fontFace: "Calibri",
  });
}
...
// ── SLIDE 5 · Aquitanian Polyphony ───────────────────────────────────────────
{
  ...
  s.addText("📍 來源與背景 Sources & Context", {
    x: 0.45, y: 1.36, w: 9.1, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("• 南法 St. Martial 修道院（Limoges）· 12 世紀手稿保存複音 versus 與聖詠裝飾\n• Codex Calixtinus（ca. 1173）· 聖地牙哥德孔波斯特拉朝聖聖殿手稿 · 含 21 首複音\n• 作品多為兩聲部 · 兩聲部皆使用拉丁文 · 多數為節慶禮儀用 · 或拉丁讚美詩 versus", {
    x: 0.5, y: 1.7, w: 9.0, h: 0.85, fontSize: 10, color: C.sand, fontFace: "Calibri",
  });

  // Discant style
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 2.7, w: 4.6, h: 2.55, fill: { color: C.wine }, rounding: true });
  s.addText("🎵 Discant 對唱風格", {
    x: 0.45, y: 2.78, w: 4.3, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  ...
  s.addText("• 兩聲部以「音對音」方式行進\n  Note-against-note counterpoint\n• 速度相近——兩聲部有明確節奏\n• 常用逆向與斜行\n• 常見於以音節式聖詠為基底之處\n• 英文 \"discant\" 源自拉丁 discantus\n  = 「分開地唱」", {
    x: 0.5, y: 3.22, w: 4.2, h: 1.95, fontSize: 9.5, color: C.cream, fontFace: "Calibri",
  });

  // Florid style
  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 2.7, w: 4.6, h: 2.55, fill: { color: C.rust }, rounding: true });
  s.addText("🌿 Florid 華麗奧爾加農", {
    x: 5.25, y: 2.78, w: 4.3, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  ...
  s.addText("• 下方聲部（tenor）以持續長音唱聖詠\n  拉丁 tenere = 「持續、держать」→ tenor\n• 上方聲部在長音之上唱華麗裝飾花唱\n  Upper voice sings melismas over sustained tones\n• 節奏自由——無固定拍子\n• 聲音效果像「在聖詠上懸浮」\n• 開創了巴黎聖母院時期的奧爾加農風格", {
    x: 5.3, y: 3.22, w: 4.2, h: 1.95, fontSize: 9.5, color: C.cream, fontFace: "Calibri",
  });
}
...
// ── SLIDE 6 · Notre Dame Cathedral & Polyphony ───────────────────────────────
{
  ...
  s.addText("🏛 聖母院與大學 Cathedral & University", {
    x: 0.45, y: 1.27, w: 9.1, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("• 建築工程：奠基 ca. 1160 · 祭壇區 1182 · 首祭 1183 · 中殿 ca. 1200 · 正立面 ca. 1250\n  Foundations ca. 1160, choir 1182, first mass 1183, nave ca. 1200, façade ca. 1250\n• 與巴黎大學（ca. 1150 創立）在地理與人脈上密不可分——是哲學與神學的中心\n  Linked to the nascent University of Paris — a center of Scholastic thought\n• 其建築的高度、華麗、結構複雜——音樂也對應地變得又長、又繁、又結構化\n  The music paralleled the cathedral: long, intricate, carefully structured", {
    x: 0.5, y: 1.6, w: 9.0, h: 1.45, fontSize: 10, color: C.cream, fontFace: "Calibri",
  });
  ...
  s.addText("🎼 傳播與口頭傳承 Transmission & Orality", {
    x: 0.45, y: 3.27, w: 9.1, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("• 此曲目在西歐傳唱逾一世紀——從西班牙到波蘭、從義大利到蘇格蘭\n  Repertory sung for over a century across Europe from Spain to Poland\n• 現存最早手稿來自 1240 年代——比曲目本身晚了數十年\n  Earliest manuscripts date from 1240s, decades after the music was first created\n• 同一曲在不同手稿中文本差異明顯 → 顯示口傳與即興仍為主要媒介\n  Versions vary between manuscripts — evidence of oral transmission alongside writing\n• 梵蒂岡所藏一份 ca. 1200 年巴黎抄本描述「如何即興演唱 Notre Dame 風格的奧爾加農」", {
    x: 0.5, y: 3.6, w: 9.0, h: 1.6, fontSize: 10, color: C.cream, fontFace: "Calibri",
  });
}
...
// ── SLIDE 7 · The Six Rhythmic Modes ─────────────────────────────────────────
{
  ...
  s.addText("Notre Dame's Great Innovation · First Notation for Duration Since Ancient Greece", {
    x: 0.4, y: 0.72, w: 9.2, h: 0.38, fontSize: 12, color: C.sand, fontFace: "Georgia", align: "center",
  });
  s.addShape(pres.ShapeType.rect, { x: 1.5, y: 1.12, w: 7, h: 0.04, fill: { color: C.gold } });

  // Context
  s.addText("Johannes de Garlandia (ca. 1260) 在 De mensurabili musica 中歸納為六種「模式」，以連音符組合（ligatures）表示", {
    x: 0.4, y: 1.25, w: 9.2, h: 0.3, fontSize: 10, color: C.sand, fontFace: "Calibri", italic: true, align: "center",
  });

  // Modes table header
  s.addShape(pres.ShapeType.rect, { x: 0.4, y: 1.65, w: 9.2, h: 0.45, fill: { color: C.gold } });
  s.addText("模式 Mode", { x: 0.5, y: 1.68, w: 1.8, h: 0.4, fontSize: 12, bold: true, color: C.darkBg, fontFace: "Georgia", align: "center" });
  s.addText("模式 Pattern", { x: 2.4, y: 1.68, w: 3.2, h: 0.4, fontSize: 12, bold: true, color: C.darkBg, fontFace: "Georgia", align: "center" });
  s.addText("現代節奏等值 Modern Equivalent", { x: 5.7, y: 1.68, w: 3.8, h: 0.4, fontSize: 12, bold: true, color: C.darkBg, fontFace: "Georgia", align: "center" });
  ...
  modes.forEach(([num, pat, eq, note], i) => {
    ...
    s.addText(pat, { x: 2.4, y: y + 0.05, w: 1.5, h: 0.35, fontSize: 13, color: C.sand, fontFace: "Calibri", align: "center" });
    s.addText(eq, { x: 3.9, y: y + 0.05, w: 2.7, h: 0.35, fontSize: 10, color: C.cream, fontFace: "Calibri" });
    s.addText(note, { x: 6.6, y: y + 0.05, w: 3.0, h: 0.35, fontSize: 9.5, color: C.sand, fontFace: "Calibri" });
  });

  s.addText("基本時間單位 tempus 永遠以三為一組——體現三位一體的完美數字「3」", {
    x: 0.4, y: 5.12, w: 9.2, h: 0.3, fontSize: 10, color: C.gold, fontFace: "Calibri", align: "center",
  });
}
...
// ── SLIDE 8 · Léonin & the Magnus liber organi ───────────────────────────────
{
  ...
  s.addText("👤 Léonin (fl. 1150s–ca. 1201)", {
    x: 0.45, y: 1.28, w: 4.3, h: 0.35, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  ...
  s.addText("• 1150 年代起任巴黎主教座堂神職\n• Notre Dame 參事、聖職者；與 St. Victor 修道院有關\n• 同時為詩人——曾以詩句改寫創世紀前八卷\n• Anonymous IV（ca. 1285 論文）稱其為\n  「excellent organista」（傑出的奧爾加農歌者/作曲家）\n• 據記載編纂了 Magnus liber organi（「大奧爾加農書」）\n\n❖ 但並非獨力完成——如同聖母院的建築，這是\n  數代歌者的集體創作", {
    x: 0.5, y: 1.78, w: 4.2, h: 3.4, fontSize: 9.5, color: C.cream, fontFace: "Calibri",
  });

  // Magnus liber
  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 1.2, w: 4.6, h: 4.0, fill: { color: C.midBrown }, rounding: true });
  s.addText("📚 Magnus liber organi", {
    x: 5.25, y: 1.28, w: 4.3, h: 0.35, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
...
// ── SLIDE 9 · Pérotin, Clausula, Conductus ───────────────────────────────────
{
  ...
  // Pérotin
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 1.3, w: 9.4, h: 1.4, fill: { color: "3A2015" }, rounding: true });
  s.addText("👤 Pérotin (fl. late 12th – early 13th c.)", {
    x: 0.45, y: 1.36, w: 9.1, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("• Anonymous IV 稱其為「Perotinus the Great」· 編訂 Magnus liber 並創作「更佳的 clausulae」\n• 首創三聲部 organum triplum 與四聲部 organum quadruplum\n  First composer of three- and four-voice organum\n• 代表作：Viderunt omnes（1198）· Sederunt principes · Alleluia Nativitas（NAWM 19）\n• 所有上聲部皆使用節奏模式 · 範圍相近 · 常以 voice exchange（聲部互換）結構長段落", {
    x: 0.5, y: 1.68, w: 9.0, h: 1.0, fontSize: 9.5, color: C.sand, fontFace: "Calibri",
  });

  // Clausula
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 2.8, w: 4.6, h: 2.45, fill: { color: C.wine }, rounding: true });
  s.addText("✂ Substitute Clausula", {
    x: 0.45, y: 2.87, w: 4.3, h: 0.32, fontSize: 12, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("clausula = 「句子、子句」\n• 奧爾加農中「一個字」或「一段花唱」的自足段落\n  A self-contained section setting a single word or syllable\n• 「替代式 clausula」可取代原曲中相同段落——\n  讓同一段聖詠有多種處理選擇\n• 多為 discant 風格（兩聲部皆有節奏模式）\n• Florence 手稿收錄 10 種 Dominus 片段的\n  替代版本——全部不具名", {
    x: 0.5, y: 3.22, w: 4.2, h: 1.95, fontSize: 9.5, color: C.cream, fontFace: "Calibri",
  });

  // Conductus
  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 2.8, w: 4.6, h: 2.45, fill: { color: C.rust }, rounding: true });
  s.addText("📜 Polyphonic Conductus", {
    x: 5.25, y: 2.87, w: 4.3, h: 0.32, fontSize: 12, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("Notre Dame 及各地複音作曲家也創作兩到四聲部的 conductus：\n• tenor 為新作旋律——不借自聖詠\n  Tenor melody is newly composed, not borrowed\n• 各聲部同時歌唱相同歌詞\n  All voices sing the same text together\n• 歌詞多為音節式設定\n• 句首、句尾、重要終止前常出現\n  花唱尾聲 caudae（「尾巴」）\n• 主題為拉丁宗教或嚴肅題材詩歌", {
    x: 5.3, y: 3.22, w: 4.2, h: 1.95, fontSize: 9.5, color: C.cream, fontFace: "Calibri",
  });
}
...
// ── SLIDE 10 · The Motet: Origins ────────────────────────────────────────────
{
  ...
  s.addText("🌱 起源 Origin", {
    x: 0.45, y: 1.26, w: 9.1, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("• 巴黎聖母院樂手在 13 世紀初，為 discant clausula 的上聲部\n  加上新的拉丁歌詞——如同之前為花唱填詞而成的 tropes 和 sequences\n• 產生的新體裁稱為「motet」（拉丁 motetus，源自法文 mot =「字」）\n• 由此，一段原本無詞的音樂裝飾（clausula），反過來被「加上文字裝飾」\n  A musical decoration gets decorated in turn with words\n• 經文歌常以各聲部第一字組成複合標題：如 Factum est salutare / Dominus", {
    x: 0.5, y: 1.62, w: 9.0, h: 1.3, fontSize: 10, color: C.cream, fontFace: "Calibri",
  });
  ...
  s.addText("📈 演變 Development Over the 13th Century", {
    x: 0.45, y: 3.13, w: 9.1, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("• 初期：拉丁宗教文本，以 clausula 為骨架 · 可在彌撒中演唱\n• 中期：增加第三、第四聲部 → double motet（兩歌詞）· triple motet（三歌詞）\n• 後期：使用法文、世俗主題 → motet 脫離教會 · 成為文化菁英的娛樂\n• tenor 原為聖詠段落，後成為純粹的音樂骨幹——Hieronymus de Moravia\n  ca. 1270 稱其為「cantus firmus」（固定曲調）\n• 至 13 世紀中葉，經文歌已取代 organum 與 conductus，成為主導的複音體裁\n  By mid-century, the motet displaced organum and conductus as the leading genre", {
    x: 0.5, y: 3.48, w: 9.0, h: 1.7, fontSize: 10, color: C.cream, fontFace: "Calibri",
  });
}
...
// ── SLIDE 11 · Franconian Notation & Late 13th c. Motet ──────────────────────
{
  ...
  s.addText("📐 Ars cantus mensurabilis", {
    x: 0.45, y: 1.38, w: 4.3, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("Franco of Cologne · ca. 1280\n「可度量音樂的藝術」\n\n❖ 革命性突破：\n用音符形狀本身表示相對時值\nNote shapes indicate duration\n\n四種單音符號：\n• Double long（倍長）\n• Long（長）\n• Breve（短）\n• Semibreve（半短）\n\n❖ 基本單位 tempus 仍以三為一組\n  三個 tempora = 一個 perfection\n  （完美的三位一體結構）\n\n❖ 此體系沿用了數世紀——\n  現代音符的祖先", {
    x: 0.5, y: 1.72, w: 4.2, h: 3.5, fontSize: 9.5, color: C.sand, fontFace: "Calibri",
  });

  // Late motet types
  s.addShape(pres.ShapeType.rect, { x: 5.1, y: 1.3, w: 4.6, h: 3.95, fill: { color: "3A2015" }, rounding: true });
  s.addText("🎼 後期經文歌風格", {
    x: 5.25, y: 1.38, w: 4.3, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addText("① Franconian Motet\n• 以 Franco 命名的新式經文歌\n• 各上聲部有獨立節奏形貌\n• 不再嚴格遵循節奏模式\n• 例：Adam de la Halle\n  De ma dame vient / Dieus / Omnes\n\n② Petronian Motet\n• Petrus de Cruce / Pierre de la Croix\n• 每 tempus 可容納多達 7 個 semibreves\n• 三聲部速度層級鮮明：\n  tenor（慢）+ duplum（中）+ triplum（快）\n• 例：Aucun ont trouvé / Lonc tans / Annuntiantes（NAWM 22）\n\n③ Choirbook Format\n• 三聲部分寫於同頁或對頁\n• triplum · motetus · tenor 各佔區域\n• 1280 起至 16 世紀沿用", {
    x: 5.3, y: 1.72, w: 4.2, h: 3.5, fontSize: 9, color: C.sand, fontFace: "Calibri",
  });
}
...
// ── SLIDE 12 · English Polyphony ─────────────────────────────────────────────
{
  ...
  // Characteristics
  s.addShape(pres.ShapeType.rect, { x: 0.3, y: 1.18, w: 4.7, h: 4.05, fill: { color: C.wine }, rounding: true });
  s.addText("🎶 英格蘭風格特徵", {
    x: 0.45, y: 1.26, w: 4.4, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addShape(pres.ShapeType.rect, { x: 0.55, y: 1.62, w: 4.2, h: 0.02, fill: { color: C.gold } });
  s.addText("• 1066 諾曼征服後，英格蘭文化音樂與\n  法國緊密連結 · 寫作 Notre Dame 各體裁\n\n• 偏好 conductus 的「同節奏」與規律樂句\n\n• 喜用不完美協和音程（三度、六度）\n  常以平行方式出現——受本土民間複音影響\n  Imperfect consonances, often in parallel\n\n• Gerald of Wales（ca. 1200）記載\n  威爾斯與北不列顛的即興部分歌唱\n\n• Hymn to St. Magnus（12 世紀）\n  奧克尼群島之守護聖人的頌歌——\n  使用連續的平行三度\n\n❖ 這些特色在 15 世紀影響歐陸作曲家\n  孕育出「國際風格 international style」", {
    x: 0.5, y: 1.74, w: 4.3, h: 3.45, fontSize: 9.5, color: C.cream, fontFace: "Calibri",
  });

  // Rondellus / Rota / Sumer
  s.addShape(pres.ShapeType.rect, { x: 5.2, y: 1.18, w: 4.5, h: 4.05, fill: { color: C.midBrown }, rounding: true });
  s.addText("🎵 聲部互換與循環", {
    x: 5.35, y: 1.26, w: 4.2, h: 0.32, fontSize: 13, bold: true, color: C.gold, fontFace: "Georgia",
  });
  s.addShape(pres.ShapeType.rect, { x: 5.45, y: 1.62, w: 4.0, h: 0.02, fill: { color: C.gold } });
  s.addText("❖ Rondellus 輪唱複音\n  三個樂句 a b c 先同時響出\n  再由三聲部輪流交換演唱：\n     Voice 1 : a b c\n     Voice 2 : c a b\n     Voice 3 : b c a\n  聽者聽到同一段三聲部樂句重複三次\n  每次聲部角色互換\n\n❖ Rota 卡農輪唱\n  同度永恆卡農（perpetual round）\n\n🎉 Sumer is icumen in（ca. 1250）\n  「夏日已來到」——最著名的 rota\n  • 四聲部同度卡農\n  • 下方兩聲部唱 pes（「腳」/持續低音）\n    彼此形成兩聲部 rondellus\n  • 最終產生 F-A-C-F 與 G-B♭-D 交替\n  • 英文歌詞讚美夏日與杜鵑鳥歌唱", {
    x: 5.4, y: 1.74, w: 4.2, h: 3.45, fontSize: 9.2, color: C.cream, fontFace: "Calibri",
  });
}
...
// ── SLIDE 14 · Timeline ──────────────────────────────────────────────────────
{
  ...
  events.forEach(([date, event], i) => {
    ...
    s.addText(date, { x: 0.2, y, w: 2.45, h: 0.26, fontSize: 8.5, color: C.midBrown, fontFace: "Calibri", align: "right", margin: 0 });
    s.addText(event, { x: 3.05, y, w: 6.6, h: 0.26, fontSize: 8.5, color: C.darkText, fontFace: "Calibri", margin: 0 });
  });
}
...
// ── SLIDE 15 · A Polyphonic Tradition (Chapter Summary) ──────────────────────
{
  ...
  points.forEach(([icon, text], i) => {
    ...
    s.addText(text, { x: 1.05, y: y + 0.05, w: 8.5, h: 0.55, fontSize: 9.5, color: C.sand, fontFace: "Calibri", margin: 0 });
  });
}
...
// ── SLIDE 16 · Further Reading & Key Terms ───────────────────────────────────
{
  ...
  const listening = [
    ...
    "Substitute clausulae on Dominus (NAWM 18)  — 教學樂譜",
  ...
  s.addText(listening.map((l, i) => ({
    text: l, options: { bullet: true, breakLine: i < listening.length - 1, fontSize: 9, color: C.cream, fontFace: "Calibri", paraSpaceAfter: 2 },
  })), { x: 0.55, y: 1.56, w: 4.0, h: 1.93 });
  ...
  const reading = [
    "Richard Hoppin — Medieval Music (Norton Introduction)",
    "Edward Roesner — \"Who 'Made' the Magnus Liber?\"",
    "Craig Wright — Music and Ceremony at Notre Dame of Paris",
    "Fritz Reckow — Der Musiktraktat des Anonymus 4",
    "Sarah Fuller — \"Early Polyphony\" in NOHM, vol. 2",
    "Wikipedia: Organum · Notre Dame school · Motet",
    "Grout HWM Online · Chapter 5 resources",
  ];
  s.addText(reading.map((r, i) => ({
    text: r, options: { bullet: true, breakLine: i < reading.length - 1, fontSize: 9.5, color: C.cream, fontFace: "Calibri", paraSpaceAfter: 2 },
  })), { x: 5.05, y: 1.56, w: 4.4, h: 1.93 });
  ...
  const terms = "Polyphony · Counterpoint · Organum · Parallel organum · Oblique motion · Note-against-note · Musica enchiriadis · Winchester Troper · Ad organum faciendum · Aquitanian polyphony · St. Martial · Codex Calixtinus · Versus · Discant · Florid (sustained-tone) organum · Tenor · Duplum · Triplum · Quadruplum · Magnus liber organi · Léonin / Pérotin · Clausula · Substitute clausula · Organum purum · Conductus · Cauda · Rhythmic modes · Ligature · Longa · Breve · Mode 1–6 · Motet · Motetus · Double/Triple motet · Cantus firmus · Franconian notation · Ars cantus mensurabilis · Petronian motet · Choirbook format · Voice exchange · Rondellus · Rota · Pes · Sumer is icumen in · Anonymous IV";
  s.addText(terms, {
    x: 0.6, y: 4.18, w: 8.8, h: 1.02, fontSize: 9, color: C.cream, fontFace: "Calibri",
  });
}
